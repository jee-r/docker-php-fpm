...
_PHP Version, PHP Info, installed PHP's modules and Alpine Version are available on [Github Action](https://github.com/jee-r/docker-php-fpm/actions/workflows/deploy.yaml) under **`specs`** job._
